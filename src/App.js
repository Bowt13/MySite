		...
		switch (event.key) {
			...
			case 'a':
				...
				if (this.state.profileInfo === 'visable') {
					if (
						document.activeElement.id === 'buttonUp' ||
						document.activeElement.id === 'buttonDown'
					) {
			...
			case 'd':
				...
				if (
					document.activeElement.id !== 'skill-card-body' ||
					document.activeElement.id !== 'project-card-body'
				) {
					this.setState({
			...
			<div
				...
				<div className="screen-holder" onClick={this.handleMachine}>
					<div className="screen">
						<div className="screen-noise-effect" />
						<div className="screen-scan-effect" />
						<div className="screen-blur-effect">
							...
							{this.state.game && <SpaceShooter />}
						</div>
					</div>
				</div>
				{false && (
					<MachineCabinet
						joystick={this.state.joystick.toLowerCase()}
						arcadeButton={this.state.arcadeButton}
					/>
				)}
			</div>
		)
