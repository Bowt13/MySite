...
import { profileInfo } from '../../data/data.js'
		...
		switch (type) {
			case 'up':
				...
				setInterval(function() {
					if (i !== 16) {
						document.getElementById('card-body').scrollBy(0, -height)
						i = i + 1
					}
				}, 30)
				break
			case 'down':
				setInterval(function() {
					if (i !== 155) {
						document.getElementById('card-body').scrollBy(0, height / 50)
						i = i + 1
					}
				}, 1)
				break
					...
					<div className="card-body" id="card-body">
						<div className="profile-body-content" id="check">
							<div className="content-left">
								<h4 className="content-title">Personal Info:</h4>
								<br />
								<p>
									Name:<br />
									Birthdate:<br />
								...
								<br />
								<h4 className="content-title">Adress:</h4>
								<br />
								<p>
									Street:<br />
									City:<br />
							...
							<div className="content-right">
								...
								<br />
								<p>
									{profileInfo.training}
									<br />
									{profileInfo.training2}
									<br />
									{profileInfo.trainingAt}
									<br />
								</p>
							</div>
							{false && (
							...
							<div className="icon-container">
								...
								<p
									className="icon-tag"
									onClick={_ => this.handleIconClick(this.props.urlFrontend)}>
									Github:
								</p>
								<img
									className="clickable-icon"
									onClick={_ => this.handleClick('gitHub')}
								...
								<img
									className="clickable-icon"
									onClick={_ => this.handleClick('linkedIn')}
